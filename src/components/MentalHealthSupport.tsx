    ...
    <section id="mental-health" className="section-container bg-gradient-to-br from-medical-blue-50 to-white">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <BlurEffect>
            <span className="inline-block px-4 py-1.5 rounded-full bg-medical-green-100 text-medical-green-700 font-medium text-sm mb-4">
              Support Resources
            </span>
          </BlurEffect>
          
          <BlurEffect delay={100}>
            <h2 className="section-title">Mental Health & Wellness</h2>
          </BlurEffect>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          <BlurEffect delay={300} className="card-hover">
            <div className="glass-effect rounded-xl p-8 h-full flex flex-col">
              <div className="mb-6">
                <div className="w-16 h-16 rounded-lg bg-medical-green-50 flex items-center justify-center">
                  <Brain className="h-8 w-8 text-medical-green-600" />
                </div>
              </div>
              <h3 className="text-xl font-bold mb-4">Counseling Services</h3>
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-center">
                  <div className="w-5 h-5 rounded-full bg-medical-green-100 flex items-center justify-center mr-3">
                  ...
                  <span className="text-gray-700">Individual counseling sessions</span>
                </li>
                <li className="flex items-center">
                  <div className="w-5 h-5 rounded-full bg-medical-green-100 flex items-center justify-center mr-3">
                    <svg className="w-3 h-3 text-medical-green-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <span className="text-gray-700">Group therapy workshops</span>
                </li>
                <li className="flex items-center">
                  <div className="w-5 h-5 rounded-full bg-medical-green-100 flex items-center justify-center mr-3">
                    <svg className="w-3 h-3 text-medical-green-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <span className="text-gray-700">Crisis intervention support</span>
                </li>
              </ul>
            ...
            <div className="glass-effect rounded-xl p-8 h-full flex flex-col">
              ...
              <div className="grid grid-cols-2 gap-3 mb-8">
                <div className="bg-white rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow border border-gray-100">
                  <h4 className="font-medium mb-2 text-medical-blue-800">Stress Management</h4>
                  <p className="text-sm text-gray-600">Techniques and exercises to manage academic stress</p>
                </div>
                <div className="bg-white rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow border border-gray-100">
                  <h4 className="font-medium mb-2 text-medical-blue-800">Sleep Improvement</h4>
                  <p className="text-sm text-gray-600">Guides for better sleep habits and routines</p>
                </div>
                <div className="bg-white rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow border border-gray-100">
                  <h4 className="font-medium mb-2 text-medical-blue-800">Mindfulness</h4>
                  <p className="text-sm text-gray-600">Meditation and mindfulness practices</p>
                </div>
                <div className="bg-white rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow border border-gray-100">
                  <h4 className="font-medium mb-2 text-medical-blue-800">Anxiety Relief</h4>
                  <p className="text-sm text-gray-600">Tools to manage anxiety and panic</p>
                </div>
              </div>
              <div className="mt-auto">
          ...
          <BlurEffect delay={500} className="card-hover">
            <div className="glass-effect rounded-xl p-8 h-full flex flex-col">
              ...
              <h3 className="text-xl font-bold mb-4">Support Communities</h3>
              <p className="text-gray-600 mb-6">
              ...
              <div className="space-y-3 mb-8">
                <div className="flex items-center p-3 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow border border-gray-100">
                  ...
                  <div>
                    <h4 className="font-medium text-medical-blue-800">Academic Stress Group</h4>
                    <p className="text-sm text-gray-600">Wednesdays, 6:00 PM</p>
                  </div>
                </div>
                <div className="flex items-center p-3 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow border border-gray-100">
                  <div className="w-10 h-10 rounded-full bg-medical-green-100 flex items-center justify-center mr-3">
                  ...
                  <div>
                    <h4 className="font-medium text-medical-green-800">Mindfulness Circle</h4>
                    <p className="text-sm text-gray-600">Mondays, 5:30 PM</p>
                  </div>
                </div>
              </div>
              <div className="mt-auto">
          ...
          <BlurEffect delay={600} className="card-hover">
            <div className="glass-effect rounded-xl p-8 h-full flex flex-col">
              ...
              <h3 className="text-xl font-bold mb-4">AI Wellness Assistant</h3>
              <p className="text-gray-600 mb-6">
              ...
              <div className="bg-white rounded-xl shadow-sm p-4 mb-8 border border-gray-100">
                <div className="flex items-start mb-4">
                  <div className="w-8 h-8 rounded-full bg-medical-blue-100 flex items-center justify-center mr-3 flex-shrink-0">
                ...
                <div className="flex items-start mb-4 justify-end">
                  <div className="bg-medical-blue-100 rounded-lg px-4 py-2 max-w-[80%]">
